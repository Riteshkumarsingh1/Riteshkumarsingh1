...
USER_NAME = os.environ['USER_NAME']  # 'Riteshkumarsingh1'
...
if __name__ == '__main__':
    """
    Ritesh Kumar Singh (Riteshkumarsingh1)
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 12, 10))  # Year, Month, Day
    # ===============================================
